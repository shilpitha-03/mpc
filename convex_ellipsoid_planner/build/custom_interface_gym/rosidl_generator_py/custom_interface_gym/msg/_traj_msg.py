...
class Metaclass_TrajMsg(type):
    """Metaclass of message 'TrajMsg'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'custom_interface_gym.msg.TrajMsg')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__traj_msg
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__traj_msg
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__traj_msg
            cls._TYPE_SUPPORT = module.type_support_msg__msg__traj_msg
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__traj_msg
...
class TrajMsg(metaclass=Metaclass_TrajMsg):
    """Message class 'TrajMsg'."""
