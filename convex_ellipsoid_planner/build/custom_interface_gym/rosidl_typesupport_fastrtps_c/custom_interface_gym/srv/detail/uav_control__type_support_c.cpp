...
#include "custom_interface_gym/srv/detail/uav_control__rosidl_typesupport_fastrtps_c.h"
...
using _UavControl_Request__ros_msg_type = custom_interface_gym__srv__UavControl_Request;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    size_t size = 4;
    auto array_ptr = ros_message->request;
...
static uint32_t _UavControl_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_interface_gym__srv__UavControl_Request(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_interface_gym__srv__UavControl_Request;
    is_plain =
      (
...
static size_t _UavControl_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_interface_gym__srv__UavControl_Request(
...
using _UavControl_Response__ros_msg_type = custom_interface_gym__srv__UavControl_Response;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    size_t size = 7;
    auto array_ptr = ros_message->response;
    cdr.serializeArray(array_ptr, size);
  }
...
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_interface_gym__srv__UavControl_Response(
      untyped_ros_message, 0));
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = custom_interface_gym__srv__UavControl_Response;
    is_plain =
      (
...
static size_t _UavControl_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_interface_gym__srv__UavControl_Response(
    full_bounded, is_plain, 0);
...
// already included above
// #include "custom_interface_gym/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "custom_interface_gym/srv/uav_control.h"
