...
bool custom_interface_gym__msg__traj_msg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custom_interface_gym.msg._traj_msg.TrajMsg", full_classname_dest, 42) == 0);
  }
  custom_interface_gym__msg__TrajMsg * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of TrajMsg */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_interface_gym.msg._traj_msg");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TrajMsg");
