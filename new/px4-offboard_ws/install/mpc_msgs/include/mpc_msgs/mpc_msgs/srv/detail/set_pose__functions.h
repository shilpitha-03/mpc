...
#ifndef MPC_MSGS__SRV__DETAIL__SET_POSE__FUNCTIONS_H_
#define MPC_MSGS__SRV__DETAIL__SET_POSE__FUNCTIONS_H_
...
#include "mpc_msgs/msg/rosidl_generator_c__visibility_control.h"
 ...
 */
ROSIDL_GENERATOR_C_PUBLIC_mpc_msgs
bool
 ...
 * calls
 * mpc_msgs__srv__SetPose_Request__init().
...
/**
 * It calls
 * mpc_msgs__srv__SetPose_Request__fini()
 ...
 * mpc_msgs__srv__SetPose_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * mpc_msgs__srv__SetPose_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * mpc_msgs__srv__SetPose_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_mpc_msgs
...
/**
 * It calls
 * mpc_msgs__srv__SetPose_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_mpc_msgs
...
/**
 * It allocates the memory for the array and calls
 * mpc_msgs__srv__SetPose_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_mpc_msgs
...
/**
 * It calls
 * mpc_msgs__srv__SetPose_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MPC_MSGS__SRV__DETAIL__SET_POSE__FUNCTIONS_H_
