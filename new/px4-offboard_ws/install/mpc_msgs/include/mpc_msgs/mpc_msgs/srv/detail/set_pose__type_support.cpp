...
{
  new (message_memory) mpc_msgs::srv::SetPose_Request(_init);
}

void SetPose_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<mpc_msgs::srv::SetPose_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SetPose_Request_message_member_array[1] = {
  {
    ...
    offsetof(mpc_msgs::srv::SetPose_Request, pose),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SetPose_Request_message_members = {
  "mpc_msgs::srv",  // message namespace
  "SetPose_Request",  // message name
  1,  // number of fields
  sizeof(mpc_msgs::srv::SetPose_Request),
...
{
  return &::mpc_msgs::srv::rosidl_typesupport_introspection_cpp::SetPose_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mpc_msgs, srv, SetPose_Request)() {
  return &::mpc_msgs::srv::rosidl_typesupport_introspection_cpp::SetPose_Request_message_type_support_handle;
}
...
void SetPose_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) mpc_msgs::srv::SetPose_Response(_init);
}

void SetPose_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<mpc_msgs::srv::SetPose_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SetPose_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(mpc_msgs::srv::SetPose_Response, result),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SetPose_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(mpc_msgs::srv::SetPose_Response),
...
{
  return &::mpc_msgs::srv::rosidl_typesupport_introspection_cpp::SetPose_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mpc_msgs, srv, SetPose_Response)() {
  return &::mpc_msgs::srv::rosidl_typesupport_introspection_cpp::SetPose_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers SetPose_service_members = {
  "mpc_msgs::srv",  // service namespace
  "SetPose",  // service name
  // these two fields are initialized below on the first access
  // see get_service_type_support_handle<mpc_msgs::srv::SetPose>()
...
get_service_type_support_handle<mpc_msgs::srv::SetPose>()
{
  ...
  auto service_type_support =
    &::mpc_msgs::srv::rosidl_typesupport_introspection_cpp::SetPose_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mpc_msgs, srv, SetPose)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<mpc_msgs::srv::SetPose>();
}
