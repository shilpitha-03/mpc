...
class Metaclass_SetPose_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('mpc_msgs')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_SetPose(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from mpc_msgs.srv import _set_pose
...
class SetPose(metaclass=Metaclass_SetPose):
    from mpc_msgs.srv._set_pose import SetPose_Request as Request
    from mpc_msgs.srv._set_pose import SetPose_Response as Response
