...
#include "mpc_msgs/srv/detail/set_pose__rosidl_typesupport_fastrtps_c.h"
...
#include "mpc_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_mpc_msgs
...
using _SetPose_Request__ros_msg_type = mpc_msgs__srv__SetPose_Request;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mpc_msgs
size_t get_serialized_size_mpc_msgs__srv__SetPose_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetPose_Request__ros_msg_type * ros_message = static_cast<const _SetPose_Request__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _SetPose_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mpc_msgs__srv__SetPose_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mpc_msgs
size_t max_serialized_size_mpc_msgs__srv__SetPose_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mpc_msgs__srv__SetPose_Request;
    is_plain =
      (
...
static size_t _SetPose_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mpc_msgs__srv__SetPose_Request(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mpc_msgs, srv, SetPose_Request)() {
...
using _SetPose_Response__ros_msg_type = mpc_msgs__srv__SetPose_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mpc_msgs
size_t get_serialized_size_mpc_msgs__srv__SetPose_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetPose_Response__ros_msg_type * ros_message = static_cast<const _SetPose_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_mpc_msgs__srv__SetPose_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mpc_msgs
size_t max_serialized_size_mpc_msgs__srv__SetPose_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = mpc_msgs__srv__SetPose_Response;
    is_plain =
      (
...
static size_t _SetPose_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mpc_msgs__srv__SetPose_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mpc_msgs, srv, SetPose_Response)() {
...
// already included above
// #include "mpc_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "mpc_msgs/srv/set_pose.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mpc_msgs, srv, SetPose)() {
