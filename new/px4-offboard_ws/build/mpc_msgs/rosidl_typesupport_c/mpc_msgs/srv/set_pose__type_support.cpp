...
static const _SetPose_Request_type_support_symbol_names_t _SetPose_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mpc_msgs, srv, SetPose_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mpc_msgs, srv, SetPose_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, mpc_msgs, srv, SetPose_Request)() {
  return &::mpc_msgs::srv::rosidl_typesupport_c::SetPose_Request_message_type_support_handle;
}
...
static const _SetPose_Response_type_support_symbol_names_t _SetPose_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mpc_msgs, srv, SetPose_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mpc_msgs, srv, SetPose_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, mpc_msgs, srv, SetPose_Response)() {
  return &::mpc_msgs::srv::rosidl_typesupport_c::SetPose_Response_message_type_support_handle;
}
...
static const _SetPose_type_support_symbol_names_t _SetPose_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mpc_msgs, srv, SetPose)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mpc_msgs, srv, SetPose)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, mpc_msgs, srv, SetPose)() {
  return &::mpc_msgs::srv::rosidl_typesupport_c::SetPose_service_type_support_handle;
}
