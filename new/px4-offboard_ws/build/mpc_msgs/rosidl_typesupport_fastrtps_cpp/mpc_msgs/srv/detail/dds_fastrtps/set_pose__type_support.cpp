...
#include "mpc_msgs/srv/detail/set_pose__rosidl_typesupport_fastrtps_cpp.hpp"
...
bool
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_mpc_msgs
cdr_serialize(
  const mpc_msgs::srv::SetPose_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mpc_msgs::srv::SetPose_Request & ros_message)
{
  // Member: pose
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mpc_msgs::srv::SetPose_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mpc_msgs::srv::SetPose_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mpc_msgs::srv::SetPose_Request *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_mpc_msgs
const rosidl_message_type_support_t *
get_message_type_support_handle<mpc_msgs::srv::SetPose_Request>()
{
  return &mpc_msgs::srv::typesupport_fastrtps_cpp::_SetPose_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mpc_msgs, srv, SetPose_Request)() {
  return &mpc_msgs::srv::typesupport_fastrtps_cpp::_SetPose_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_mpc_msgs
cdr_serialize(
  const mpc_msgs::srv::SetPose_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: result
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mpc_msgs::srv::SetPose_Response & ros_message)
{
  // Member: result
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = mpc_msgs::srv::SetPose_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mpc_msgs::srv::SetPose_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<mpc_msgs::srv::SetPose_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &mpc_msgs::srv::typesupport_fastrtps_cpp::_SetPose_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mpc_msgs, srv, SetPose_Response)() {
  return &mpc_msgs::srv::typesupport_fastrtps_cpp::_SetPose_Response__handle;
}
...
{
  return &mpc_msgs::srv::typesupport_fastrtps_cpp::_SetPose__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mpc_msgs, srv, SetPose)() {
  return &mpc_msgs::srv::typesupport_fastrtps_cpp::_SetPose__handle;
}
