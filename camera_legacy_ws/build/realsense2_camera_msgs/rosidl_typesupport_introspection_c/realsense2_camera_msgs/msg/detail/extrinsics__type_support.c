...
static rosidl_typesupport_introspection_c__MessageMember realsense2_camera_msgs__msg__Extrinsics__rosidl_typesupport_introspection_c__Extrinsics_message_member_array[3] = {
  {
    "header",  // name
    ...
    offsetof(realsense2_camera_msgs__msg__Extrinsics, header),  // bytes offset in struct
    NULL,  // default value
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, realsense2_camera_msgs, msg, Extrinsics)() {
  realsense2_camera_msgs__msg__Extrinsics__rosidl_typesupport_introspection_c__Extrinsics_message_member_array[0].members_ =
